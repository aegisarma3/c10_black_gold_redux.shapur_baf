...
{
    _newPos = [_avgCenter, ([_avgCenter, _x] call Zen_Find2dDistance), (([_avgCenter, _x] call Zen_FindDirection) - _rotateAngle), "trig", ZEN_STD_OBJ_PZT(_x)] call Zen_ExtendPosition;
